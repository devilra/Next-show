...
const CentralizedJsonBulkCreate = sequelize.define(
  "CentralizedJsonMovieCreate",
  {
    id: {
    ...
    // // Puthiya oru field: ithu namma automation-ku help pannum
    // theatreRunDays: {
    //   type: DataTypes.INTEGER,
    //   defaultValue: 20, // Default-ah 30 naal website-la "New Release"-ah kaatuvom
    // },
    ...
    movieStatus: {
      type: DataTypes.ENUM("WAITING", "RELEASED", "COMPLETED"),
    ...
    availableOn: {
      type: DataTypes.JSON,
      defaultValue: [], // Default-ah theater-nu store aagum
    },
    ...
    boxOffice: {
      ...
      defaultValue: {
        ...
        verdict: "", // Hit, Flop, Blockbuster, Average, Disaster
  ...
  {
    tableName: "centralized_json_bulk_create",
    timestamps: true,
    hooks: {
...
module.exports = CentralizedJsonBulkCreate;
