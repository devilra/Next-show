...
exports.CentralizedCreateMovie = async (req, res) => {
  ...
  try {
    ...
    for (const movie of moviesData) {
      ...
      else if (movie.isManualUpdate === true) {
    ...
    const [
      ...
      CentralizedJsonBulkCreate.findAll({
        ...
        order: [
          ...
          ["theatreReleaseDate", "ASC"], // Full Date + Time (Earliest first)
          ["id", "DESC"],
        ],
      }),
      CentralizedJsonBulkCreate.findAll({
        ...
        order: [
          [sequelize.literal("theatreReleaseDate IS NULL"), "ASC"],
          ["theatreReleaseDate", "DESC"], // Full Date + Time (Latest first)
          ["id", "DESC"],
        ],
      }),
      CentralizedJsonBulkCreate.findAll({
      ...
      CentralizedJsonBulkCreate.findAll({
        ...
        order: [
          ...
          ["ottReleaseDate", "ASC"], // Full Date + Time sorting
          ["id", "DESC"],
        ],
      }),
      CentralizedJsonBulkCreate.findAll({
        ...
        order: [
          [sequelize.literal("ottReleaseDate IS NULL"), "ASC"],
          ["ottReleaseDate", "DESC"], // Full Date + Time sorting
          ["id", "DESC"],
        ],
      }),
      CentralizedJsonBulkCreate.findAll({
