...
const MovieSection = ({ activeItems }) => {
  console.log("Movie section", activeItems);
  ...
  const openSidebar = (title, data) => {
    setSidebarData({ isOpen: true, title, data });
  };

  // Movie Column Component (Reusable)
  const MovieColumn = ({ title, movies, categoryTitle }) => (
    <div className="flex flex-col h-full">
      <div className="flex justify-between items-center mb-4 border-l-4 border-orange-400 pl-3">
