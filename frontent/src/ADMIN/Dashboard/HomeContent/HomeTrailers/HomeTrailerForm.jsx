...
import {
  createHomeTrailerContent,
  fetchAllHomeTrailers,
  updateHomeTrailerContent,
} from "../../../../redux/HomeContentSlice/HomeTrailerSlice";

const HomeTrailerForm = ({ isOpen, onClose, contentData, setAlert }) => {
  const dispatch = useDispatch();
  const { isLoading } = useSelector((state) => state.homeTrailers);
  ...
  const handleSubmit = async (e) => {
    ...
    const action = isEdit
      ? updateHomeTrailerContent({ id: contentData.id, formData: data })
      : createHomeTrailerContent(data);
...
export default HomeTrailerForm;
